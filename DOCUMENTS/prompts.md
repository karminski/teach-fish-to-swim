...
请帮我根据这个读书笔记, 整理一个网页, 每个笔记要点整理为一个卡片，卡片为 3:4 比例展示内容, 注意不要让内容超过卡片大小或者出现滚动条, 如果内容实在太长可以分上下两个卡片或者多个卡片来解释. 网页整体使用银灰色配色，参考apple官网风格. 卡片的页码和上一页下一页均展示在屏幕右下角的卡片外部。并且增加快捷键 Ctrl+方向键可以控制切换前一个或者后一个卡片. 尽量少使用emoji，仅在对错, 孰优孰劣这样的场景进行适当使用emoji来引导用户注意力. 另外页面主要是用来帮助大家理解论文，因此尽可能像PPT，但是比PPT应该风丰富一些，做到有问题，有过程，有结论即可。
